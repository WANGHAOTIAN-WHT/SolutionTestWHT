    ...
    public partial class EmailSendHistory: IActiveRecord
    {
        ...
        public override string ToString(){
			StringBuilder sb = new StringBuilder();
            			sb.Append("Id = " + Id + "\r\n");
            			sb.Append("SendUsers_Id = " + SendUsers_Id + "\r\n");
            			sb.Append("SendUsers_Name = " + SendUsers_Name + "\r\n");
            			sb.Append("SendUsers_Email = " + SendUsers_Email + "\r\n");
            			sb.Append("RecUsers_Id = " + RecUsers_Id + "\r\n");
            			sb.Append("RecUsers_Name = " + RecUsers_Name + "\r\n");
            			sb.Append("RecUsers_Email = " + RecUsers_Email + "\r\n");
            			sb.Append("RecUserLevel_Id = " + RecUserLevel_Id + "\r\n");
            			sb.Append("RecUserLevel_Name = " + RecUserLevel_Name + "\r\n");
            			sb.Append("EmailSubject = " + EmailSubject + "\r\n");
            			sb.Append("EmailContent = " + EmailContent + "\r\n");
